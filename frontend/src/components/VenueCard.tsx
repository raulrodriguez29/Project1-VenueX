...
export default function VenueCard({name, location, description}: VenueCardProps) {
  return (
    <div
      ...
      >
        ...
        <div className="p-5">
          <h3 className="font-semibold text-lg text-gray-700 group-hover:text-pink-600 transition-colors">
            {name}
          </h3>
